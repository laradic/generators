...
class DefinitionBuilder
{
    public function class($class)
    {
        ...
        $docBlock   = new DocBlock($reflection, new Context($reflection->getNamespaceName()));
    ...
    public function method($class, $name)
    {
        ...
        $docBlock   = new DocBlock($reflection, new Context($reflection->getDeclaringClass()->getNamespaceName()));
